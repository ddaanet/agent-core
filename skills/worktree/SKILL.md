...
1. **Read `agents/session.md`** and run `claudeutils _worktree ls` to identify all tasks and plan statuses. Extract task names, plan directories, and any blockers that might create dependencies.
