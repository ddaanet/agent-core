...
**Diverge before assessing** (internal reasoning, not output):
...
**Research your own claims:**
- What claims does your assessment make? Which are grounded in evidence vs pure reasoning?
- What evidence would change your assessment? Does that evidence exist?
- If checkable — search (web search, codebase exploration) before asserting. Especially for feasibility claims.
- Flag ungrounded claims explicitly: "ungrounded — based on reasoning, not evidence"
...
Then research your agreement: what evidence would disprove your position? Search if checkable. Re-affirm or change position.
