---
name: vet-agent
description: Execute vet reviews with quiet execution pattern (writes review to file, returns terse result). Use this agent when delegating vet reviews from orchestration workflows or when detailed review output should be in a file rather than conversation.
model: sonnet
color: cyan
